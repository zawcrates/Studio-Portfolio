...
import { Camera, Heart, Film, Globe, MessageSquare, Award } from 'lucide-react';
    ...
    <div className="w-full min-h-screen pt-32 pb-24 bg-background">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center mb-28">
          ...
          <div className="lg:col-span-5 relative h-[450px] rounded-2xl overflow-hidden border border-white/5 shadow-2xl">
            <Image
        ...
        {/* Founder Section */}
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center mb-28 bg-card p-8 sm:p-12 rounded-3xl border border-white/5">
          <div className="lg:col-span-5 relative h-[400px] rounded-2xl overflow-hidden border border-white/5 shadow-xl lg:order-2">
            <Image
        ...
        <section className="flex flex-col gap-12 mb-20">
          <h2 className="font-serif text-3xl text-center text-white font-light">
            Our Core Creative Pillars
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="glass p-8 rounded-2xl border border-white/5 flex flex-col gap-4">
              <div className="w-10 h-10 rounded-lg bg-gold/10 flex items-center justify-center text-gold">
                <Film className="w-5 h-5" />
              </div>
              <h3 className="font-serif text-xl text-white font-light">Cinematic Lighting</h3>
            ...
            <div className="glass p-8 rounded-2xl border border-white/5 flex flex-col gap-4">
              ...
              <h3 className="font-serif text-xl text-white font-light">Candid Storytelling</h3>
              <p className="text-sm text-gray-400 font-light leading-relaxed">
            ...
            <div className="glass p-8 rounded-2xl border border-white/5 flex flex-col gap-4">
              ...
              <h3 className="font-serif text-xl text-white font-light">Artisanal Grading</h3>
              <p className="text-sm text-gray-400 font-light leading-relaxed">
        ...
        <div className="text-center mt-12">
          <Link
            href="/contact"
            className="px-8 py-3.5 rounded-full bg-gold text-black hover:bg-gold-hover transition-all duration-300 text-xs uppercase tracking-widest font-semibold inline-block"
          >
            Work With Us
          </Link>
        </div>
