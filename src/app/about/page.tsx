      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <section className="flex flex-col gap-12 mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="glass p-8 rounded-2xl border border-border/5 flex flex-col gap-4">
        ...
        <div className="text-center mt-12">
          <Link
            href="/contact"
            className="px-8 py-3.5 rounded-full bg-accent text-black hover:bg-accent-hover transition-all duration-300 text-xs uppercase tracking-widest font-semibold inline-block"
          >
            Work With Us
          </Link>
        </div>
